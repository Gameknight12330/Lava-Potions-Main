...
@OnlyIn(Dist.CLIENT)
public class ReaperSkullRenderer extends EntityRenderer<ReaperSkull> {
   private static final ResourceLocation WITHER_INVULNERABLE_LOCATION = new ResourceLocation("textures/entity/wither/wither_invulnerable.png");
   private static final ResourceLocation WITHER_LOCATION = new ResourceLocation("textures/entity/wither/wither.png");
   private final SkullModel model;

   public ReaperSkullRenderer(EntityRendererProvider.Context p_174449_) {
      super(p_174449_);
   ...
   public void render(ReaperSkull p_116484_, float p_116485_, float p_116486_, PoseStack p_116487_, MultiBufferSource p_116488_, int p_116489_) {
      p_116487_.pushPose();
   ...
   public ResourceLocation getTextureLocation(ReaperSkull p_116482_) {
