...
public enum ModArmorMaterials implements ArmorMaterial {
    OLYMPIOS("olympios", 999999, new int[]{9, 18, 24, 9}, 0, SoundEvents.ARMOR_EQUIP_GOLD,
            2.0F, 0.0F, () -> Ingredient.of(ItemInit.OLYMPIOS_INGOT.get()));
    ...
    public String getName() {
        return LavaPotions.MOD_ID + ":" + this.name;
    }
